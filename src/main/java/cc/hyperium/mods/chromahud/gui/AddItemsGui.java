...
public class AddItemsGui extends Screen {
    ...
    public void tick() {
        ...
        buttons.forEach(guiButton -> {
            ...
            if (guiButtonConsumer != null) guiButtonConsumer.accept((ButtonWidget) guiButton);
        });
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        if (adding) {
            ...
            for (ChromaHUDParser parser : parsers) {
                ...
                client.textRenderer.drawWithShadow(text, (current.getScaledWidth() - client.textRenderer.getStringWidth(text)) >> 1, cursorY, Color.RED.getRGB());
                cursorY += 30;
                ...
                for (Map.Entry<String, String> entry : names.entrySet()) {
                    ...
                    if (displayElement == null) {
                        ...
                        client.textRenderer.drawWithShadow(text2, (current.getScaledWidth() - client.textRenderer.getStringWidth(text2)) >> 1, cursorY, Color.RED.getRGB());
                        cursorY += 15;
                        continue;
                    }
                    ...
                    client.textRenderer.drawWithShadow(text1, (int) ((current.getScaledWidth() - totalWidth) / 2), cursorY, Color.RED.getRGB());
